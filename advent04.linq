...
bool One(string str) =>
	((int)str[0] == (int)str[1] && (int)str[1] != (int)str[2]) ? true : false;

bool Two(string str) =>
	((int)str[2] == (int)str[1] && (int)str[1] != (int)str[3] && (int)str[1] != (int)str[0]) ? true : false;
	
bool Three(string str) =>
	((int)str[3] == (int)str[2] && (int)str[2] != (int)str[4] && (int)str[2] != (int)str[1]) ? true : false;

bool Four(string str) =>
	((int)str[4] == (int)str[3] && (int)str[3] != (int)str[5] && (int)str[3] != (int)str[2]) ? true : false;

bool Five(string str)
	((int)str[5] == (int)str[4] && (int)str[4] != (int)str[3]) ? true : false;