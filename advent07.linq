		...
		switch (opcode)
		{
			case '1':
				try
				{
					...
					Console.WriteLine($"1: {parameters[0]} {parameters[1]} {parameters[2]}");
				}
			...
			case '2':
				try
				{
					...
					if (parameters[2] == '1') { intcode[i + 3] = mode1 * mode2; }
					if (parameters[2] == '0') { intcode[intcode[i + 3]] = mode1 * mode2; }
					Console.WriteLine($"2: {parameters[0]} {parameters[1]} {parameters[2]}");
				}
			...
			case '3':
				try
				{
					...
					i -= 2;
					Console.WriteLine($"3: {parameters[0]}");
				}
			...
			case '4':
				try
				{
					...
					i -= 2;
					Console.WriteLine($"4: {parameters[0]}");
				}
			...
			case '5':
				try
				{
					...
					Console.WriteLine($"5: {parameters[0]} {parameters[1]}");
				}
			...
			case '6':
				try
				{
					...
					Console.WriteLine($"6: {parameters[0]} {parameters[1]}");
				}
			...
			case '7':
				try
				{
					...
					Console.WriteLine($"7: {parameters[0]} {parameters[1]}");
				}
			...
			case '8':
				try
				{
					...
					Console.WriteLine($"8: {parameters[0]} {parameters[1]}");
				}
...
Task.Run(() => doIt(sequence[0]));
Task.Run(() => doIt(sequence[1]));
Task.Run(() => doIt(sequence[2]));
Task.Run(() => doIt(sequence[3]));
Task.Run(() => doIt(sequence[4]));